...
export const tagline = 'We Believe in Making the Universe Better';

export const mission = 'Our mission is to empower every individual and \
  business in the known universe by optimizing and developing comprehensive \
