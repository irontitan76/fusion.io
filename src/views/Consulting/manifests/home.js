export const title = 'FUSION CONSULTING';

export const services = {
  items: [
    {
      description: 'Our Social Group focuses on connecting humanity. \
        Whether its a marketing campaign, advertising, or technology \
        that creates or improves a consumer ecosystem, our social \
        engineers are visionary individuals with an affinity for \
        creating relationships between your business and indviduals.',
