export const standards = [
  {
    ...
    content: [
      {
        author: 'Vance Havner',
        quote: 'The vision must be followed by the venture. It is not \
          enough to stare up the steps - we must step up the stairs.',
        type: 'quote',
      },
      {
        body: '<p>In order to establish a moral business with a \
          collaborative culture, flat organizational structure, \
          flexible career pathways, explicit process, and overarching \
          brand, Fusion Industries establishes \
          <u>The Fusion Standard</u> as our living and extensible \
          constitution and wields this constitution to determine \
          courses of action in business commencements and \
          transformations.</p>',
        type: 'html',
      },
      {
    ...
    content: [
      {
        ...
        <p>\
          ...
          section. Every divisional president is part of the executive \
          team at Fusion Industries wherein the team determines company \
          direction and strategy by logical reasoning and voting.\
        </p>\
        \
        <p>\
          Of note, the division of Fusion Technology is the governing body\
          for the technology stack used throughout the entire company barring \
          a venture or artifical intelligence arm. It has the purpose of \
          defining the technical architecture of web applications, software \
          design, and development workflows so that cohesiveness between \
          divisions is realized.\
        </p>',
        type: 'html',
      }
    ],
    ...
    content: [
      {
        body: '<p>\
          ...
          head. The Operating Core - those that <i>directly</i> influence\
          offerings - are at the pyramid\'s apex, because we believe leaders\
          are foundational. In other words, leaders guide their team with\
